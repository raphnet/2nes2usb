...
static void setupDescriptors()
{
	if (fourscore_mode || multitap_mode) {
		...
		SnesGamepad.num_reports = 2;
		SnesGamepad.reportDescriptorSize = sizeof(two_nsnes_usbHidReportDescriptor);
		SnesGamepad.reportDescriptor = (void*)two_nsnes_usbHidReportDescriptor;
	}
}

Gamepad SnesGamepad = {
	.num_reports			= 2,
	.reportDescriptorSize 	= sizeof(two_nsnes_usbHidReportDescriptor),
	.init					= fournsnesInit,
